    ...
    <div className='bg-primary dark:bg-tertiary py-24 sm:py-32'>
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <dl className='grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3'> {/* sm:grid-cols-2  */} 
                ...
                >
                    <dt className='text-white leading-7'> {/* text-base text-muted-foreground */}
                        Transacton every 24 hours
                    </dt>
                    <dd className='order-first text-3xl font-semibold tracking-tight text-white sm:text-5xl'> {/* md:text-4xl */}
                        <Badge
                            endCountNum={44}
