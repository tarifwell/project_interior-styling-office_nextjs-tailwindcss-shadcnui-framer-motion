...
const page = () => {
  ...
  return (
    <div>
      <div className="bg-[url('/images_about/about_whoweare.jpg')] bg-center bg-cover">
      ...
      <div className="container p-8">
        ...
        <div className="items-center lg:flex gap-x-8">
          ...
          <motion.div 
            ...
            className="w-full">
            <Image 
              src="/images_about/about_gallery.jpg" 
              width={700} 
              height={700} 
              alt="about" 
            />
          ...
          >
            ...
            >Read More <ArrowUpRight className="w-5 h-5 ml-2"/></Button>
          </motion.div>
        </div>
          ...
          <div className="grid py-8 gap-20 lg:grid-cols-3">
            ...
            <motion.div 
              ...
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-tertiary -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
                  src="/images_profile/profile2.jpg"
                  width={200}
                  height={200}
                  alt="profile"
            ...
            <motion.div 
              ...
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-tertiary -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
                  src="/images_profile/profile1.jpg"
                  width={200}
                  height={200}
                  alt="profile"
                  className="mx-auto rounded-full"
            ...
            <motion.div 
              ...
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-tertiary -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
                  src="/images_profile/profile3.jpg"
                  width={200}
                  height={200}
                  alt="profile"
                  className="mx-auto rounded-full"
